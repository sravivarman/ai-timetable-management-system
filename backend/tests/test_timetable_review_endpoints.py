...
class TimetableReviewEndpointTests(unittest.TestCase):
 def setUp(self):
  ...
  try:
   ...
   users={"dean":User(username="review-dean",email="dean.review@vce.ac.in",full_name="Dean",password_hash=hash_password("Password123"),roles=[dean]),"principal":User(username="review-principal",email="principal.review@vce.ac.in",full_name="Principal",password_hash=hash_password("Password123"),roles=[principal]),"student":User(username="review-student",email="student.review@vce.ac.in",full_name="Student",password_hash=hash_password("Password123"),roles=[student])};db.add_all(users.values());db.flush()
