...
class TimetableEntryMove(BaseModel):
 working_day_id:UUID;actual_date:date|None=None;period_number:int=Field(ge=1,le=7);classroom_id:UUID|None=None;laboratory_id:UUID|None=None;lock_after_move:bool=True
...
class TimetableGridEntry(BaseModel):
 entry_id:UUID;laboratory_rotation_block_id:UUID|None=None;combined_teaching_event_id:UUID|None=None;combined_teaching_group_code:str|None=None;combined_section_codes:list[str]=Field(default_factory=list);working_day_id:UUID;actual_date:date|None=None;day_name:str;period_number:int;period_numbers:list[int];schedule_type:str;start_time:time;end_time:time
...
class TimetableGridDay(BaseModel): working_day_id:UUID;actual_date:date|None=None;day_name:str;sequence_number:int;entries:list[TimetableGridEntry]
class TimetableGridResponse(BaseModel): version_id:UUID;view_type:str;resource_id:UUID;schedule_type:str;scheduling_mode:str="WEEKLY";scheduling_slot_id:UUID|None=None;days:list[TimetableGridDay]
...
class FreeResourceResponse(BaseModel): version_id:UUID;working_day_id:UUID;actual_date:date|None=None;period_number:int;items:list[dict]
